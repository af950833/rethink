...
const t2deviceTypes: Record<string, T2Factory> = {
    POT_056905_WW,
    RAC_056905_WW,
    ['PAC_910604_WW']: RAC_056905_WW, // Korean floor-standing AC; compatible TLV protocol
    ...
    ['Hd0C_F']: T1789EFH_F, // Korean top-loading washer; same AA/BB 0xEB status protocol
